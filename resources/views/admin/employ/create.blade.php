...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            @endif
                <form action="{{ url('admin/employ') }}"  method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-md-6 col-sm-12">                            
                           ...
                           <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="designeation"  class="form-control">
                                @error('designeation')
                                <small class="text-danger">{{$message}}</small>    
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6 col-sm-12">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea rows="5" name="bio" class="form-control"></textarea>
                            </div>
                            <div class="col-12">
